...
public:
    ...
    //we don't need a destructor because the smart ptr manages the memory for us
...
StrBlob& StrBlob::operator=(const StrBlob& rhs){
    //The smart pointer automatically does the memory management for us,
    //no need to go through making a new object and assigning it to data
    //and deleting the other object
