...
//I think it could be fun to iterate on this and make it handle more stuff
//TO DO:
//how to handle input like 1+2, 1+ 2, 1 +2, etc.
//get an entire line of text, like 1 + 2 + 3 * 4 and process it correctly.
//how exactly would I go about doing that...
//handle parenthesis... etc...

//ok, so need to remove white space and have one big line? but when does it end?
