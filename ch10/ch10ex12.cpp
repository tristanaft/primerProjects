...
//I dont remember where my big class version of sales data is defined...
//so ill use the version from github...
//I should go find it and turn it into a header...
class Sales_data;
...
int main() {
  ...
  double price;
  std::string fileName = "ch10ex12input.in";
